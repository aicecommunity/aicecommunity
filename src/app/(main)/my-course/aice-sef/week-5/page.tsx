    ...
    <div className="md:p-6 p-3 space-y-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-200">
        ...
        <h2 className="font-bold md:text-xl text-lg mb-4 text-gray-800">
          <span className="text-gray-500 mr-2">AICE-SEF-5:</span>
        ...
        <div className="space-y-5 text-gray-700 mb-6">
          <p className="text-base">
            This week introduces you to <strong>Python</strong>, one of the most beginner-friendly and widely used programming languages in the world. Python powers automation, AI, cybersecurity, data science, mobile apps, back-end development, and much more.
          </p>

          <p className="text-base">
            You will begin by learning how to <strong>install Python</strong> on your device, run Python programs, and use the <strong>Python Interpreter</strong> for quick testing. You will also set up <strong>Visual Studio Code</strong> for Python development using extensions and the built-in terminal.
          </p>

          <p className="text-base">
            Once your environment is ready, you will write your <strong>first Python program</strong> and explore how Python reads, runs, and structures code. You’ll learn how to work with errors, fix them, and write clean, organized code.
          </p>

          <p className="text-base">
            This week also covers the core building blocks of Python: <strong>variables, data types, strings, numbers, input/output, operators,</strong> and proper <strong>code formatting</strong>. These fundamentals will prepare you for more advanced concepts like loops, functions, and data structures.
          </p>

          <p className="text-base">
            Your learning experience includes <strong>multiple-choice quizzes</strong>, <strong>practical coding tasks</strong>, and <strong>theory assignments</strong> designed to reinforce your understanding and help you build real programming skills.
          </p>

          <p className="text-base">
            By the end of this week, you will be confident in writing basic Python programs and fully prepared for deeper Python development in the upcoming weeks.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            {resources
              .filter(item => item.id >= 10 && item.id <= 11) // adjust IDs for Week 5
              .map((item, i) => (
                <Link
                  key={item.id}
        ...
        <div className="mb-4">
          ...
          <div className="relative w-full h-64 sm:h-80 md:h-96 rounded-md overflow-hidden">
            <iframe
              ...
              src="https://www.youtube.com/embed/VIDEO_ID" // replace with actual Python intro video
